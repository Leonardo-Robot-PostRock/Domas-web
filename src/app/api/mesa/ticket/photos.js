...
export default async function handler (req, res) {
    ...
    if (req.method === 'GET'){
        ...
        let response = await axios.get(`${process.env.AUTH_BASE_URL}/v1/ticket/mesa/${ticket_id}/photos`, {
            headers: {
        ...
        let response = await axios.post(`${process.env.AUTH_BASE_URL}/v1/ticket/mesa/${ticket_id}/photos`, data, {
            headers: {
                'Cookie': `auth_service=${session}`
            }
        })
        ...
        let response = await axios.delete(`${process.env.AUTH_BASE_URL}/v1/ticket/mesa/${ticket_id}/photos/${req.query.photo_id}`, {
            headers: {
                'Cookie': `auth_service=${session}`
            }
        })
