...
export default async function handler (req, res) {
    ...
    const {recurrent, fromDate, toDate} = req.query;
   
    let response = await axios.get(`${process.env.AUTH_BASE_URL}/v1/dashboard/service-log?recurrent=${recurrent}&from_date=${fromDate}&to_date=${toDate}`, {
        headers: {
