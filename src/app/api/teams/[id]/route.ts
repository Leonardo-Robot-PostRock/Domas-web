...
export async function GET(request: RequestObject, { params }: { params: GetParams }) {
...
export async function PATCH(request: RequestObject, { params }: { params: GetParams }) {
  const token = request.cookies.get('auth_service');
...
export async function DELETE(request: RequestObject, { params }: { params: GetParams }) {
  const token = request.cookies.get('auth_service');
